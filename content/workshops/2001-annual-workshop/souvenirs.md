...
{{< figure src="img/ppig-2001/panorama-dance.jpg" >}}

<br>

|    |    |
| ---|--- |
| {{< figure src="img/ppig-2001/quiz-4.jpg" class="tr" >}} | The following evening, some of us participated in a quiz, ... |
| {{< figure src="img/ppig-2001/quiz-2.jpg" class="tr" >}} | ... where it was not only the questions that were surprising! |
| {{< figure src="img/ppig-2001/quiz-5.jpg" class="tr" >}} | Rivalry was intense, ... |
| {{< figure src="img/ppig-2001/quiz-winners.jpg" class="tr" >}} | ... but there was only one winning team. |
| {{< figure src="img/ppig-2001/prizes.jpg" class="tr" >}} | We agree! A successful workshop! |
| {{< figure src="img/ppig-2001/alan.jpg" class="tr" >}} | But all good things have to come to an end, we say. As we pack up our things ... |
| {{< figure src="img/ppig-2001/ws.jpg" class="tr" >}} | ... and head for home, ... |
| {{< figure src="img/ppig-2001/thos-gary.jpg" class="tr" >}} | ... the Brunel can be seen in the distance. |

_Text by Chris Douce._ \
_Photos by Paola Kathuria & Frank Wales._
...
|    |    |
| ---|--- |
| {{< figure src="img/ppig-2001/wynne.jpg" class="tr" >}} | _Richard Wynne_ - Head of the School of Design, Engineering and Computing - welcomes PPIG to Bournemouth University. |
| {{< figure src="img/ppig-2001/liam.jpg" class="tr" >}} | _Liam Bannon_, invited speaker. |
| {{< figure src="img/ppig-2001/carina.jpg" class="tr" >}} | _Carine Paine_ next to _Kit Logan_ |
| {{< figure src="img/ppig-2001/kit.jpg" class="tr" >}} | _Kit Logan_ |
| {{< figure src="img/ppig-2001/robert.jpg" class="tr" >}} | _Robert Gittins_ |
| {{< figure src="img/ppig-2001/martha.jpg" class="tr" >}} | | {{< figure src="img/ppig-2001/martin.jpg" class="tr" >}} | _Martin Shepperd_ on the discussion panel. |
| {{< figure src="img/ppig-2001/marian.jpg" class="tr" >}} | _Marian Petre_ on the discussion panel. |
| {{< figure src="img/ppig-2001/rob.jpg" class="tr" >}} | _Rob Hague_ |
| {{< figure src="img/ppig-2001/roger.jpg" class="tr" >}} | _Roger Stone_ |
| {{< figure src="img/ppig-2001/gary.jpg" class="tr" >}} | _Gary Olson_, invited speaker |
| {{< figure src="img/ppig-2001/chris.jpg" class="tr" >}} | _Chris Douce_ |
| {{< figure src="img/ppig-2001/yang.jpg" class="tr" >}} | _Jun Yang_ |
| {{< figure src="img/ppig-2001/jarinee.jpg" class="tr" >}} | _Jarinee Chattratichart_ |
| {{< figure src="img/ppig-2001/dan.jpg" class="tr" >}} | _Dan Diaper_ considers decaf for the next break. |
| {{< figure src="img/ppig-2001/holmboe.jpg" class="tr" >}} | _Christian Holmboe_ |
| {{< figure src="img/ppig-2001/linda-2.jpg" class="tr" >}} | _Linda McIver_ |
| {{< figure src="img/ppig-2001/linda.jpg" class="tr" >}} | _Linda McIver_ |
| {{< figure src="img/ppig-2001/moti.jpg" class="tr" >}} | _Modechai Ben-Ari_ |
| {{< figure src="img/ppig-2001/orit.jpg" class="tr" >}} | _Orit Hazzan_ |
| {{< figure src="img/ppig-2001/maria.jpg" class="tr" >}} | _Maria Kutar_ |
| {{< figure src="img/ppig-2001/markku.jpg" class="tr" >}} | _Markku Tukiainen_ |
| {{< figure src="img/ppig-2001/markuu-3.jpg" class="tr" >}} | _Markku Tukiainen_, man of action. |
| {{< figure src="img/ppig-2001/steven.jpg" class="tr" >}} | _Steven Clarke_ |
